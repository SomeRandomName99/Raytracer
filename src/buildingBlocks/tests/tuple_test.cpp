...
TEST(tuple_tests, vector_creation_correct) {
...
/* =========== Creation Test Point =========== */
TEST(tuple_tests, point_creation_correct) {
...
TEST(tuple_tests, tuple_addition_correct) {
...
TEST(tuple_tests, tuple_subtraction_vector_vector_isVector_correct) {
...
TEST(tuple_tests, tuple_subtraction_point_vector_isPoint_correct) {
...
TEST(tuple_tests, tuple_subtraction_point_point_isVector_correct) {
    const auto pnt1 = Point(3, 2, 1);
...
TEST(tuple_tests, tuple_magnitude_x_1_correct) {
    const auto vec1 = Vector(1, 0, 0);
    EXPECT_FLOAT_EQ(vec1.magnitude(), 1);
}

TEST(tuple_tests, tuple_magnitude_y_1_correct) {
    const auto vec1 = Vector(0, 1, 0);
    EXPECT_FLOAT_EQ(vec1.magnitude(), 1);
}

TEST(tuple_tests, tuple_magnitude_z_1_correct) {
    const auto vec1 = Vector(0, 0, 1);
    EXPECT_FLOAT_EQ(vec1.magnitude(), 1);
}

TEST(tuple_tests, tuple_magnitude_all_pos_correct) {
    const auto vec1 = Vector(1, 2, 3);
    EXPECT_FLOAT_EQ(vec1.magnitude(), std::sqrt(14));
}

TEST(tuple_tests, tuple_magnitude_all_neg_correct) {
    const auto vec1 = Vector(-1, -2, -3);
    EXPECT_FLOAT_EQ(vec1.magnitude(), std::sqrt(14));
}
...
TEST(tuple_tests, tuple_dot_product_correct) {
    const auto vec1 = Vector(1, 2, 3);
...
TEST(tuple_tests, tuple_a_cross_b_correct) {
    const auto vec1 = Vector(1, 2, 3);
    const auto vec2 = Vector(2, 3, 4);
...
TEST(tuple_tests, tuple_b_cross_a_correct) {
    const auto vec1 = Vector(1, 2, 3);
    const auto vec2 = Vector(2, 3, 4);
    const auto vec3 = Vector(1, -2, 1);
...
TEST(tuple_tests, tuple_negate_correct) {
    const auto tuple1 = Tuple(1, 2, 3, 4);
